 ...
 * lifecycle transitions ({@link Metric}); this aggregates them into counters,
 * gauges, and lightweight histogram summaries exposed at `/healthz`. Swap for a
...
class Metrics {
    ...
    /** Point-in-time view of all metrics, for the health endpoint. */
    snapshot() {
        return {
